        ...
        <div className="mx-auto flex max-w-6xl items-center gap-4 px-4 py-3">
          <Link href="/" className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              <div className="text-xs font-bold tracking-widest text-muted-foreground opacity-80">
                MONSTERS PROPS INC.
              </div>
              <div className="font-black tracking-tighter">怪獸道具工廠</div>
            </div>
          </Link>
            ...
            {nav.map((item) => (
              <Link
                ...
                className={cn(
                  ...
                  loc === item.href ? "text-primary" : "text-muted-foreground"
                )}
              >
                {item.label}
              </Link>
          ...
          <div className="ml-auto flex items-center gap-2 md:ml-0">
            ...
            <Button size="sm" className="gap-2 shadow-lg shadow-primary/20" asChild>
              <Link href="/quote">
                ...
                <span>詢價單</span>
                {count > 0 && (
                  <Badge variant="secondary" className="ml-1 px-1.5 h-5 min-w-[20px] flex items-center justify-center">
                    {count}
                  </Badge>
                )}
              </Link>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm">
                ...
                <li className="flex items-center gap-3 text-muted-foreground">
                  ...
                  <span>hello@monsters-props.win</span>
                </li>
                <li className="pt-4">
